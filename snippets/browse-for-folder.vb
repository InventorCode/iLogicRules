...
Function BrowseForFolder(
	...
	'This function will execute faster if an instance of Excel is already running and ForceNewXLInstance = False
	'However, it is more reliable to leave ForceNewXLInstance = True, because if this function tries to grab an instance of Excel
